...
console.log(guestList);
console.log("Sorry ".concat(guestList[4], ", I can't invite you to a dinner"));
guestList.pop();
console.log(guestList);
// Removing guest from a list
console.log("Sorry ".concat(guestList[3], ", I can't invite you to a dinner"));
guestList.pop();
console.log(guestList);
// Removing guest from a list
console.log("Sorry ".concat(guestList[2], ", I can't invite you to a dinner"));
guestList.pop();
console.log(guestList);
console.log("".concat(guestList[0], ", ").concat(guestList[1], " You Both Are Still Invited Please be on time"));
// Emptying the list
guestList.pop();
guestList.shift();
console.log(guestList);
